...
from .mnist_runners import build_mnist_assigned_noise_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description='Assign matched latent noises for MNIST targets.')
    parser.add_argument('--generator_ckpt', type=str, required=True)
    parser.add_argument('--output_dir', type=str, default='outputs/mnist_assigned_dataset')
    ...
    build_mnist_assigned_noise_dataset(**vars(args))
